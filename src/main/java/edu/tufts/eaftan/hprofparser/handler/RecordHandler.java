...
/**
 * Primary interface to be used with the hprof parser.  The parser takes an implementation of this
 * interface and calls the matching callback method on each record encountered. Implementations of
 * this interface can do things like printing the record or building a graph.
 *
